...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 07 juin 2024 à 19:38
...
(3, 'Les projets', 'Ici, vous postez vos projets que vous avez créé tout au long de votre BTS SIO.', '2024-06-07', '2024-06-07', 0, 4, 9),
(4, 'Entreprises', 'Ici, vous partagez votre expérience en entreprise: vos projets, vos anecdotes, vos compétences acquises.', '2024-06-07', '2024-06-07', 0, 3, 9);
...
(25, '', '', '2024-06-05', 'Test1234', '$2y$10$46HPDIp3qA/xBzU7cQmNQecflcg4icPX1MlWsV3vyaiKZFL.Lr6Gi', 'testtt@test.test', NULL, '', 0),
(26, '', '', '2024-06-05', 'User', '$2y$10$SAD..zOB0tVpOMSwLOctDe5gr7RflP/f.S8Nclevpxm9LKrRMXJI2', 'user@user.user', NULL, '', 0),
(27, '', '', '2024-06-07', 'TEST1', '$2y$10$/KGkSaMn5.WBQj/lGfFwHumIEQyCBJbS7vMqnoCxesy/ca0bnwibK', 'test1@gmail.com', NULL, '', 0);
...
--
ALTER TABLE `topic`
  MODIFY `ID_topic` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
